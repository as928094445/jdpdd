...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"VUE_APP_NAME":"京东拼多多联盟小程序（已开源）","VUE_APP_PLATFORM":"mp-weixin","NODE_ENV":"development","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
/* 4 */
/*!******************************************************!*\
  !*** D:/HBuilderProjects/京东拼多多联盟小程序（已开源）/pages.json ***!
  \******************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/* 11 */
/*!**********************************************************!*\
  !*** D:/HBuilderProjects/京东拼多多联盟小程序（已开源）/store/index.js ***!
  \**********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _index = __webpack_require__(/*! @/utils/luch-request/index.js */ 13);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
var store = new _vuex.default.Store({
  ...
  mutations: {
    setAsset: function setAsset(state, item) {
      state.myAsset = item || {};
    },
    setApprove: function setApprove(state, item) {
      state.isApprove = item || false;
    },
    setFormId: function setFormId(state, item) {
      state.FormId = item || 0;
    },
    setElites: function setElites(state, elites) {
      state.elites = elites || 0;
    },
    setPid: function setPid(state, pid) {
      state.pid = pid || 0;
    },
    setHotSearch: function setHotSearch(state, hot) {
      state.hotSearch = hot || [];
    },
    setAllianceType: function setAllianceType(state, op) {
    ...
    authKey: function authKey(state, info) {
    ...
    tologin: function tologin(state, provider) {

      uni.checkSession({
        success: function success(res) {
          var reData = uni.getStorageSync('authKey');
          if (reData) {
    ...
    loginFun: function loginFun(state, provider) {
      uni.login({
        provider: provider,
        ...
        success: function success(res) {
          _index.http.post('/login', { 'code': res.code, 'pid': state.pid }).then(function (res) {
            if (res.data.ret == 200) {
    ...
    getUserInfo: function getUserInfo(state) {var _this = this;
      uni.getUserInfo({
        provider: 'weixin',
        success: function success(result) {
          // store.commit('login',result.userInfo)                   
          _index.http.post('/upuser', { 'userinfo': result.rawData }).then(function (res) {
            if (res.data.ret == 200) {
              var reData = res.data.data;
...
/* 13 */
/*!***********************************************************************!*\
  !*** D:/HBuilderProjects/京东拼多多联盟小程序（已开源）/utils/luch-request/index.js ***!
  \***********************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
http.interceptor.response(function (response) {/* 请求之后拦截器 */
  if (response.data.ret !== 200) {// 服务端返回的状态码不等于200，则reject()
...
/* 14 */
/*!*************************************************************************!*\
  !*** D:/HBuilderProjects/京东拼多多联盟小程序（已开源）/utils/luch-request/request.js ***!
  \*************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* 24 */
/*!*********************************************************!*\
  !*** D:/HBuilderProjects/京东拼多多联盟小程序（已开源）/utils/util.js ***!
  \*********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {var _index = __webpack_require__(/*! @/utils/luch-request/index.js */ 13);
...
var utils = {
  getSearch: function getSearch(data, callback) {
    if (!data) data = {};
    var _this = this;
    _index.http.post('/search', data).then(function (res) {
      if (res.data.ret == 200) {
        var reData = res.data.data;
        callback(reData);
      }
  ...
  getThemeList: function getThemeList(data, callback) {
    if (!data) data = {};
    var _this = this;
    _index.http.post('/themes', data).then(function (res) {
      if (res.data.ret == 200) {
        var reData = res.data.data;
        callback(reData);
      }
  ...
  savePoster: function savePoster(_this, posterUrl) {
    if (!posterUrl) return;
    // let _this = this;
...
/* 49 */
/*!********************************************************************************!*\
  !*** D:/HBuilderProjects/京东拼多多联盟小程序（已开源）/components/utils/clipboard.thorui.js ***!
  \********************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
